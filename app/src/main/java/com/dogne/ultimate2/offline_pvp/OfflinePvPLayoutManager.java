...
public class OfflinePvPLayoutManager
{
    public OfflinePvPGameManager gameManager;
    public OfflinePvPLayoutConnector layoutConnector;
    public CountDownTimer countDownTimer;

    public Integer currentlySelectedIndex;
    public Integer previouslySelectedIndex;

    public OfflinePvPLayoutManager(AppCompatActivity activity,UTTT uttt,Timer x,Timer o)
    {
        layoutConnector = new OfflinePvPLayoutConnector(uttt.getRow(),uttt.getColumn(),activity);
        gameManager = new OfflinePvPGameManager();
        gameManager.setUttt(uttt);

        currentlySelectedIndex = null;
        previouslySelectedIndex = null;

        gameManager.setPlayerX(x);
        gameManager.setPlayerO(o);
    ...
    public OfflinePvPLayoutManager(AppCompatActivity activity,int row , int column)
    {
        layoutConnector = new OfflinePvPLayoutConnector(row,column,activity);
        gameManager = new OfflinePvPGameManager();
        ...
        gameManager.setPlayerX((Timer) null);
        gameManager.setPlayerO((Timer) null);
        gameManager.uttt.getReady();
    ...
    {
        layoutConnector.runningMenu.findViewById(R.id.offline_pvp_menu_running_root_forfeit).setOnClickListener(new View.OnClickListener()
        {
            @Override
        ...
        layoutConnector.runningMenu.findViewById(R.id.offline_pvp_menu_running_root_draw).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                gameManager.uttt.setBoardState(UTTT.DRAW_STATE);
                update();
            }
        });
    }
    ...
    {
        layoutConnector.notRunningMenu.findViewById(R.id.offline_pvp_menu_notrunning_toggleVirtual).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        layoutConnector.notRunningMenu.findViewById(R.id.offline_pvp_menu_notrunning_undo).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        layoutConnector.notRunningMenu.findViewById(R.id.offline_pvp_menu_notrunning_redo).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        layoutConnector.notRunningMenu.findViewById(R.id.offline_pvp_menu_notrunning_save).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
    ...
    private void updateTypeButton()
    {
        ...
        Button button = layoutConnector.menu.findViewById(R.id.offline_pvp_menu_notrunning_toggleVirtual);
        if(button == null)
            return;
