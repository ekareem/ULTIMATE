...
public class OfflinePvPGameManager
{
    Analytic analytic;
    //current uttt
    public UTTT uttt;
    ...
    public void setPlayerX(Long maxTime, Long timeAdded, boolean overtime)
    {
        X = new Player(uttt,UTTT.X_STATE,maxTime,timeAdded,overtime);
    }

    public void setPlayerO(Long maxTime, Long timeAdded, boolean overtime)
    {
        O = new Player(uttt,UTTT.O_STATE,maxTime,timeAdded,overtime);
    }

    public void setPlayerX(Timer timer)
    {
        X = new Player(uttt,UTTT.X_STATE,timer);
    }

    public void setPlayerO(Timer timer)
    {
