package com.dogne.ultimate2.MagicText;
...
public class MagicTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public void init(AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            if(a.hasValue(R.styleable.MagicTextView_fbackground)){
                Drawable background = a.getDrawable(R.styleable.MagicTextView_fbackground);
                if(background != null){
                    this.setBackgroundDrawable(background);
                }else{
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_fbackground, 0xff000000));
                }
            }
