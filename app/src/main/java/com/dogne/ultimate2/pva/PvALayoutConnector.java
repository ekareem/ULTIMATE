...
public class PvALayoutConnector
{
    private int row;
    private int column;
    ...
    public PvALayoutConnector(int row, int column, AppCompatActivity activity)
    {
        this.row = row;
        this.column = column;
    ...
    private void gameBarConnection()
    {
        ...
        runningMenu = (LinearLayout) inflater.inflate(R.layout.layout_pva_menu_running, menu,false);
        notRunningMenu = (LinearLayout) inflater.inflate(R.layout.layout_pva_menu_notrunning, menu,false);
            ...
            for (int j = 0; j < column; j++)
            {
                ...
                for (int k = 0; k < row ; k++)
                {
                    ...
                    for (int l = 0; l < column ; l++)
                    {
                        ...
                        int index = (i * row + j) * (row * column) + (k * row + l);
                        input.setTag(index);
